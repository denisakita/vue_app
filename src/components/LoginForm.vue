                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row px-3"> <label class="mb-1">
                            ...
                            </label> <input class="mb-4" type="text" v-model="username" required="" name="username" placeholder="Enter username"> 
                        </div>
                        <div class="row px-3">
                            <label class="mb-1">
                        ...
                        <div class="row mb-3 px-3">
                            <button type="submit" @click.prevent="loginSubmit" class="btn btn-blue text-center">Login</button> 
                        </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        loginSubmit(event) {
            ...
            localStorage.setItem("auth_token", window.btoa(token));
